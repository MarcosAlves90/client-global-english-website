...
import { buildPageMetadata, createHomeStructuredData, serializeJsonLd } from "@/lib/seo"

export const metadata: Metadata = buildPageMetadata({
  title: "Plataforma de inglês para alunos e professores",
  description:
    "Cursos, atividades, materiais, agenda, notas, progresso e feedback em uma experiência organizada para aprender e ensinar inglês.",
  path: "/",
})
